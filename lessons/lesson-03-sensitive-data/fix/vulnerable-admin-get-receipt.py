...
# VULNERABLE: No authorization check anywhere in this handler.
# Any caller who can invoke this Lambda receives a presigned URL
# to download ALL customer receipts for the specified date period.
# There is no check on who the caller is, no admin token validation,
# no check on the caller's permissions, and no check on the date parameters.
